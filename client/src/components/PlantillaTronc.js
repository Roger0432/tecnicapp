...
const PlantillaTronc = ({ files, columnes, agulla, castellersTronc, onCellClick }) => {
  ...
  const crearCanalla = useCallback((taula) => {
      ...
      switch (columnes) {
          case 1:
              enxanetaRow.push(<td className='cela' key={key_enxaneta1} onClick={() => handleCellClick(key_enxaneta1)}>{getCastellerPosicio(key_enxaneta1)}</td>);
              taula.push(<tr key='enxaneta-row'>{enxanetaRow}</tr>);

              acotxadorRow.push(<td className='cela' key={key_acotxador1} onClick={() => handleCellClick(key_acotxador1)}>{getCastellerPosicio(key_acotxador1)}</td>);
          ...
          case 2:
              ...
              dososRow.push(<td className='cela' key={key_dosos1} onClick={() => handleCellClick(key_dosos1)}>{getCastellerPosicio(key_dosos1)}</td>);
              dososRow.push(<td className='cela' key={key_dosos2} onClick={() => handleCellClick(key_dosos2)}>{getCastellerPosicio(key_dosos2)}</td>);
          ...
          case 5:
              ...
              acotxadorRow.push(<td className='cela' key={key_acotxador2} onClick={() => handleCellClick(key_acotxador2)}>{getCastellerPosicio(key_acotxador2)}</td>);
              taula.push(<tr key='acotxador-row'>{acotxadorRow}</tr>);

              dososRow.push(<td className='cela' key={key_dosos1} onClick={() => handleCellClick(key_dosos1)}>{getCastellerPosicio(key_dosos1)}</td>);
              dososRow.push(<td className='cela' key={key_dosos2} onClick={() => handleCellClick(key_dosos2)}>{getCastellerPosicio(key_dosos2)}</td>);
              dososRow.push(<td key='empty-5-8'></td>);
              dososRow.push(<td className='cela' key={key_dosos3} onClick={() => handleCellClick(key_dosos3)}>{getCastellerPosicio(key_dosos3)}</td>);
              dososRow.push(<td className='cela' key={key_dosos4} onClick={() => handleCellClick(key_dosos4)}>{getCastellerPosicio(key_dosos4)}</td>);
              taula.push(<tr key='dosos-row'>{dososRow}</tr>);
              break;
  ...
  const crearTronc = useCallback((taula) => {
      ...
      for (let i = 0; i < novesFiles; i++) {
          ...
          for (let j = 0; j < columnes; j++) {
              ...
              row.push(<td className='cela' key={key_tronc} onClick={() => handleCellClick(key_tronc)}>{getCastellerPosicio(key_tronc)}</td>);
          }

          if (agulla) {
              const key_agulla = `agulla-${i}`;
              row.push(<td className='cela agulla' key={key_agulla} onClick={() => handleCellClick(key_agulla)}>{getCastellerPosicio(key_agulla)}</td>);
          }
