...
function CrearEsdeveniment({ assaig }) {
  ...
  const [nom, setNom] = useState(
    esdeveniment.nom || (assaig ? "Assaig general" : "")
  );
    ...
    <>
            ...
            {assaig ? (
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value="Plaça del TecnoCampus">
                    Plaça del TecnoCampus
                  </MenuItem>
                  <MenuItem value="Local de Capgrossos">
                    Local de Capgrossos
                  </MenuItem>
                </Select>
              </FormControl>
      ...
      >
        <DialogTitle id="success-dialog-title">
          {assaig
            ? editar
              ? "Assaig guardat correctament"
              : "Assaig creat correctament"
            : editar
              ? "Diada guardada correctament"
