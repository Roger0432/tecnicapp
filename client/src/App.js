...
function App() {
  ...
  return (
    <div className="App">
      {!["/inicisessio", "/registre"].includes(location.pathname) &&
      ...
      <Routes>
        ...
        <Route
          path="/crear-assaig"
          element={<CrearEsdeveniment assaig={true} />}
        />
        <Route
          path="/crear-diada"
          element={<CrearEsdeveniment assaig={false} />}
        />

        <Route
          path="/editar-assaig/:id"
          element={<CrearEsdeveniment assaig={true} />}
        />
        <Route
          path="/editar-diada/:id"
          element={<CrearEsdeveniment assaig={false} />}
        />

        <Route
          path="/assaig/:id"
          element={<DetallsEsdeveniment assaig={true} />}
        />
        <Route
          path="/diada/:id"
          element={<DetallsEsdeveniment assaig={false} />}
        />
        ...
        <Route
          path="/nova-prova/:id"
          element={<AfegirCastell assaig={true} />}
        />
        <Route
          path="/nou-castell/:id"
          element={<AfegirCastell assaig={false} />}
        />
      </Routes>
    </div>
  );
